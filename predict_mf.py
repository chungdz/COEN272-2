...
print('load data')
test5p = os.path.join(args.dpath, 'test5_mf.npy')
test10p = os.path.join(args.dpath, 'test10_mf.npy')
test20p = os.path.join(args.dpath, 'test20_mf.npy')
...
run(args, test5set, 'mf_test5.txt')
run(args, test10set, 'mf_test10.txt')
run(args, test20set, 'mf_test20.txt')
